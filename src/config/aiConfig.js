...
export const aiConfig = {
  ...
  apiService: {
    ...
    provider: process.env.REACT_APP_AI_PROVIDER || 'local', // Change default to 'local' to avoid external API dependency
    apiKey: process.env.REACT_APP_GEMINI_API_KEY || null,
    baseURL: process.env.REACT_APP_AI_API_BASE_URL || 'http://localhost:3001/api',
